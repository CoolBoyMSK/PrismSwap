...
import "../../src/aggregatorRouter/PrismHub.sol";
...
contract PrismHubInitial is Test {
    ...
    function setUp() public {
        hubContract = new PrismHub(admins, 1e16);
