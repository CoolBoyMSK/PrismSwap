...
contract Uv4ExecutorTest is PrismBaseTest {
    ...
    function testFromEthToUSDCV4() public {
        ...
        PrismStructs.HopPath[] memory singlePaths = new PrismStructs.HopPath[](1);
        {
            ...
            PrismStructs.SwapStep memory simpleSwap = PrismStructs.SwapStep(1e18, 12, payload);
            swaps[0] = simpleSwap;
    ...
    function testFromUSDCToWethV4() public {
        ...
        PrismStructs.HopPath[] memory singlePaths = new PrismStructs.HopPath[](2);
        {
            ...
            PrismStructs.Adapter memory adapter = PrismStructs.Adapter(payable(adapter1), 1e18, swaps);
            adapters[0] = adapter;
            PrismStructs.HopPath memory singlePath0 = PrismStructs.HopPath(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE, adapters);
            singlePaths[0] = singlePath0;
        }
        {
