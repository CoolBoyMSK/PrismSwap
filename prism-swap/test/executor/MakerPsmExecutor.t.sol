...
contract MakerPsmExecutorTest is PrismBaseTest {
    function testMakerlitePsmExecutorFromDAIToUSDC() public {
        ...
        PrismStructs.SwapStep memory simpleSwap = PrismStructs.SwapStep(1e18, 2, payload);
        swaps[0] = simpleSwap;
        ...
        adapters[0] = adapter;
        PrismStructs.HopPath memory singlePath = PrismStructs.HopPath(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48, adapters);
    ...
    //     PrismStructs.Adapter memory adapter = PrismStructs.Adapter(payable(adapter1), 1e18, swaps);
    //     adapters[0] = adapter;
    //     PrismStructs.HopPath memory singlePath = PrismStructs.HopPath(0x6B175474E89094C44Da98b954EedeAC495271d0F, adapters);
    //     PrismStructs.HopPath[] memory singlePaths = new PrismStructs.HopPath[](1);
    //     singlePaths[0] = singlePath;
    //     PrismStructs.RouteGroup memory multiPath = PrismStructs.RouteGroup(1e18, singlePaths);
    //     PrismStructs.RouteGroup[] memory multiPaths = new PrismStructs.RouteGroup[](1);
    ...
    function testMakerPsmExecutorWrongToken() public {
        ...
        cheats.expectRevert("MakerPsm: invalid token");
        router.swap(
