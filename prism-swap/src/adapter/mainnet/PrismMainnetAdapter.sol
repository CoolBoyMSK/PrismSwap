...
contract PrismMainnetAdapter is
    IAdapter,
    AlgebraV3Executor,
    UniswapV2Executor,
    MakerPsmExecutor,
    ...
    UniswapV4Executor
{
    ...
    function executeSimpleSwap(
        ...
        for (uint256 i = 0; i < swaps.length; i++) {
            PrismStructs.SwapStep memory swap = swaps[i];
            ...
            if (swap.swapType == 1) {
                ...
                revert("PrismExecutor: invalid swapType");
            }
        }
        require(totalPercent == SignedDecimalMath.ONE, "Adapter: Invalid total percent");
    }
